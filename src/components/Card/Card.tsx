...
const Card: React.FC<CardProps> = ({ data, index = 0 }) => {
  ...
  return (
    ...
    >
      ...
      <section className="relative p-4 md:p-7 -mt-7 bg-blue-pale dark:bg-blue-dark rounded z-10 hover:bg-blue-darken dark:hover:bg-blue-lighten hover:cursor-pointer transition">
